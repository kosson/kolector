function clbkDOMContentLoaded () {
    var csrfToken = document.getElementsByName('_csrf')[0].value || null;
    ...
    let templateName = document.querySelector('#tmpl').value || null;
    
    console.log(`Am urmatoarele date: `, csrfToken, templateName);
    ...
    function showUserDetails (descriere) {
        ...
        if (descriere.hasOwnProperty('googleProfile')) {
            ...
            userAvatar.src = `/${templateName}/img/karl-magnuson-85J99sGggnw-unsplash-small.jpg`;
